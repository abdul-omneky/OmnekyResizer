...
class Sampler(BaseSampler):    
    ...
    def inference(self, in_path, im_name, bs=1, noise_repeat=False, one_step=False, return_tensor=False, apply_decoder=True):
        '''
        Inference demo.
        Input:
            in_path: str, folder or image path for LQ image
            im_name: str, Output image file name
        ...
        self.write_log(f"Processing done, enjoy the results for file {im_name}")
        return return_res
